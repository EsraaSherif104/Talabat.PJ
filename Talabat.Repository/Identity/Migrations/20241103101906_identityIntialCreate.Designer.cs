...
namespace Talabat.Repository.Identity.Migrations
{
    ...
    [Migration("20241103101906_identityIntialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Talabat.Core.Entities.identity.Addres", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Talabat.Core.Entities.identity.Addres", b =>
                {
                    b.HasOne("Talabat.Core.Entities.identity.AppUser", "User")
                        .WithOne("addres")
                        .HasForeignKey("Talabat.Core.Entities.identity.Addres", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
